...
class FCDenseNet(nn.Module):
    def __init__(self, in_channels=6, down_blocks=(5,5,5,5,5),
        ...
        ## First Convolution ##
        self.add_module('firstconv', nn.Conv2d(in_channels=in_channels, out_channels=out_chans_first_conv, kernel_size=3
        ...
        self.finalConv = nn.Conv2d(in_channels=cur_channels_count, out_channels=3, kernel_size=1, stride=1, padding=0
                                   , bias=True)
